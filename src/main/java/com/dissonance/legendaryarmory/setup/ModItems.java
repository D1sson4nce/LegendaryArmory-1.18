...
public class ModItems {
    ...
    public static final Item GIFT_OF_METAL = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    ...
    public static final Item GIFT_OF_DARKNESS = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item CURED_LEATHER = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item ONYX_LODESTONE = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item OBSIDIAN_SHARD = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item GIFT_OF_ASCALON = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item DUNGEON_DROPS = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item GIFT_OF_FORTUNE = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item GLOB_OF_ECTOPLASM = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item MYSTIC_CLOVER = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item MYSTIC_COIN = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    ...
    public static final Item GIFT_OF_MAGIC = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item VIAL_OF_BLOOD = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item TOTEM = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item VENOM_SAC = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item CRYSTALLINE_DUST = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item GIFT_OF_MIGHT = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item ANCIENT_BONE = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item CLAW = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item FANG = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item SCALE = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item GIFT_OF_MASTERY = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item BLOODSTONE_SHARD = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item GIFT_OF_EXPLORATION = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
    public static final Item GIFT_OF_BATTLE = new Item(new FabricItemSettings().group(Setup.LEGENDARY_ARMORY_GROUP));
